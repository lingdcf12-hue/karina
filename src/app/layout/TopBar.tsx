...
export function TopBar() {
  ...
  return (
    <div className="h-14 grid grid-cols-[auto_1fr_auto] items-center px-4 gap-2 bg-black w-full min-w-0 flex-shrink-0">
      {/* Left: Spotify Logo */}
      ...
      <div className="flex items-center gap-2 w-full max-w-[600px] mx-auto">
        ...
        <button
          onClick={() => setCurrentView('home')}
          className={`flex-shrink-0 w-10 h-10 rounded-full hidden sm:flex items-center justify-center transition-all bg-[#1c1c1c] hover:scale-105 hover:bg-[#2a2a2a] ${
      ...
      <div className="flex items-center justify-end gap-1.5">
        {!user ? (
          ...
          <>
            ...
            {/* User Avatar — dark circle, persis seperti Spotify */}
            <div className="relative group cursor-pointer ml-1 shrink-0">
              <button className="w-8 h-8 rounded-full overflow-hidden hover:scale-105 transition-all ring-2 ring-transparent hover:ring-white/30 bg-[#535353]">
                <img
              ...
              <div className="absolute right-0 top-full mt-2 w-48 bg-[#282828] rounded shadow-2xl overflow-hidden opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-[100] border border-[#3e3e3e]">
