...
interface MusicStore extends PlayerState {
  ...
  currentView: 'home' | 'search' | 'liked-songs' | 'queue' | 'playlist' | 'artist' | 'login' | 'register';
  setCurrentView: (view: 'home' | 'search' | 'liked-songs' | 'queue' | 'playlist' | 'artist' | 'login' | 'register') => void;
